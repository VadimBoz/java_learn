public class Main {
    public static void main(String[] args) {
        ...
        if (fI == "")
            System.out.printf("1. вхождения строки \"%s\" в строку \"%s\" не найдены\n", str2, str1);
        else
            System.out.printf("1. индексы вхождения строки \"%s\" в строку \"%s\"  -   %s\n", str2, str1, fI);
    ...
    static private String checkMirror(String str1, String str2) {
        ...
        if (res == 0)
            return String.format("строки %s  и %s являются отражением друг друга", str1, str2);
        else
            return String.format("строки %s  и %s не являются отражением друг друга", str1, str2);
    }
